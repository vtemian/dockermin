...
.PHONY: help venv install install-light test test-pure lint fmt scrape annotate smoke-reward leaderboard clean
...
lint: ## Run ruff check on src tests scripts
	$(RUFF) check src tests scripts

fmt: ## Run ruff format on src tests scripts
